...
!TEST
 if(mype.eq.0) then
    write(6,*) 'Before mg_initialize'
 endif
!TEST
  if(multigrid_betafct) then
!misha                                            call btim(   binit_tim)
     call mg_initialize
!misha                                            call etim(   binit_tim)
  endif
!MGBF
!TEST
 if(mype.eq.0) then
    write(6,*) 'After mg_initialize'
 endif
!TEST
...
!***
!misha                                            call etim(   total_tim)


!misha     call print_mg_timers("timing_cpu.csv", print_cpu)
!TEST
 if(mype.eq.0) then
    write(6,*) 'Before mg_finalize'
 endif
!TEST
...
!TEST
 if(mype.eq.0) then
    write(6,*) 'After mg_finalize'
 endif
!TEST

!TEST
!   if(mype==0) then
!     write(6,*) 'before etime(total_tim)'
!   endif
!TEST
...
!TEST
!   if(mype==0) then
!     write(6,*) 'after etime(total_tim)'
!   endif
!TEST
!***
!*** Print MGBF wall clock and cpu timing
!***
!TEST      call print_mg_timers("timing_cpu.csv", print_cpu)
