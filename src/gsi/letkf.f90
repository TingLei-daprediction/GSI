...
tend = mpi_wtime()
call mpi_allreduce(tend-tbegin,tmean,1,mpi_real8,mpi_sum,mpi_comm_world,ierr)
tmean = tmean/numproc
...
call mpi_allreduce(t2,tmean,1,mpi_real8,mpi_sum,mpi_comm_world,ierr)
tmean = tmean/numproc
...
call mpi_allreduce(t3,tmean,1,mpi_real8,mpi_sum,mpi_comm_world,ierr)
tmean = tmean/numproc
...
call mpi_allreduce(t4,tmean,1,mpi_real8,mpi_sum,mpi_comm_world,ierr)
tmean = tmean/numproc
...
call mpi_allreduce(t5,tmean,1,mpi_real8,mpi_sum,mpi_comm_world,ierr)
tmean = tmean/numproc
