...
!                                                     M. Rancic (2020) !
!   (STA - STand Alone version)                                        !
!***********************************************************************
use mpi
use kinds, only: r_kind,i_kind
use mg_parameter
use mpimod, only: mype  !GSI
...
!STA                  ,WORKA
use berror, only: mgbf_line
use mg_interpolate,only: lsqr_mg_coef,lwq_vertical_coef,def_offset_coef
!STA use mg_input, only: input_2d,input_3d,input_spec1_2d
!STA use mg_output, only: output_spec1_2d,output_vertical_2d
