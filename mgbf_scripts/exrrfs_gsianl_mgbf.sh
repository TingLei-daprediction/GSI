...
#GSISRCDIR="/scratch1/NCEPDEV/da/Miodrag.Rancic/Ting/GSI"
...
#source $moddir/modulefile.ProdGSI.hera
...
bg_and_obs_dir=/scratch1/NCEPDEV/da/Miodrag.Rancic/Ting/RRFS_conus_3km_for_MGBF/2022020204/anal_conv_gsi_spinup_test
cd $workdir
cp $bg_and_obs_dir/* .
